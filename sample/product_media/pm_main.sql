...
@/home/oracle/scripts/sample/product_media/pm_cre.sql   -- create objects
@/home/oracle/scripts/sample/product_media/pm_p_ord.sql -- load ORDSYS types

REM =======================================================
REM use sqlldr to populate PRINT_MEDIA and its nested table
REM =======================================================
 
@/home/oracle/scripts/sample/product_media/pm_p_lob &pass &data_path &log_path &work_path &connect_string

REM =======================================================
REM finish
REM =======================================================

@/home/oracle/scripts/sample/product_media/pm_analz -- gather statistics 
