...
@/home/oracle/scripts/sample/human_resources/hr_main.sql &&password_hr &&default_ts &&temp_ts &&password_sys &&logfile_dir &&connect_string

CONNECT system/&&password_system@&&connect_string
SET SHOWMODE OFF

@/home/oracle/scripts/sample/order_entry/oe_main.sql &&password_oe &&default_ts &&temp_ts &&password_hr &&password_sys __SUB__CWD__/order_entry/ &&logfile_dir &vrs &&connect_string

CONNECT system/&&password_system@&&connect_string

SET SHOWMODE OFF

@/home/oracle/scripts/sample/product_media/pm_main.sql &&password_pm &&default_ts &&temp_ts &&password_oe &&password_sys __SUB__CWD__/product_media/ &&logfile_dir __SUB__CWD__/product_media/ &&connect_string

CONNECT system/&&password_system@&&connect_string
SET SHOWMODE OFF

@/home/oracle/scripts/sample/info_exchange/ix_main.sql &&password_ix &&default_ts &&temp_ts &&password_sys &&logfile_dir &vrs &&connect_string

CONNECT system/&&password_system@&&connect_string
SET SHOWMODE OFF

@/home/oracle/scripts/sample/sales_history/sh_main &&password_sh &&default_ts &&temp_ts &&password_sys __SUB__CWD__/sales_history/ &&logfile_dir &vrs &&connect_string

CONNECT system/&&password_system@&&connect_string
SET SHOWMODE OFF

@/home/oracle/scripts/sample/bus_intelligence/bi_main &&password_bi &&default_ts &&temp_ts &&password_sys &&password_oe &&password_sh &&logfile_dir &vrs &&connect_string
...
@/home/oracle/scripts/sample/mkverify &&password_system &veri_spool &&connect_string
